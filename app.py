...
def det_mouse_zones(frame, draw_det_zone=True, draw_mouse_zone=True,
    ...
    if draw_mouse_zone:
        cv.rectangle(frame, (xd + mouse_shift, yd + mouse_shift),
                     (xd + det_zone_width - mouse_shift, yd + det_zone_height - mouse_shift),
                     (255, 255, 255), 2)
...
def main():
    ...
    driver.get('https://www.youtube.com/watch?v=WcIcVapfqXw')
    ...
    while True:
        ...
        if results.multi_hand_landmarks is not None:
            for hand_landmarks, handedness in zip(results.multi_hand_landmarks,
                ...
                recognizedHandGesture = hand_sign_id
                if (1 <= recognizedHandGesture <= 16):
                    something = True
                if (recognizedHandGesture == 11):
                    print("Pause")
                    driver.execute_script('document.getElementsByTagName("video")[0].pause()')
                    time.sleep(0.3)
                elif (recognizedHandGesture == 10):
                    print("Play")
                    driver.execute_script('document.getElementsByTagName("video")[0].play()')
                    time.sleep(0.3)
                    ...
                    pyautogui.press('up')
                    time.sleep(0.3)
                elif (recognizedHandGesture == 1):
                    pyautogui.press('down')
                    time.sleep(0.3)
                elif (recognizedHandGesture == 15):
                    ...
                    pyautogui.press("c")
                    time.sleep(0.3)
                elif (recognizedHandGesture == 13):
                    driver.execute_script('document.getElementsByTagName("video")[0].volume = 1')
                    time.sleep(0.3)
                elif (recognizedHandGesture == 14):
                    driver.execute_script('document.getElementsByTagName("video")[0].volume = 0')
                    time.sleep(0.3)
                elif (recognizedHandGesture == 16):
                    pyautogui.press('right')
                    time.sleep(0.3)
                elif (recognizedHandGesture == 2):
                    pyautogui.press('left')
                    time.sleep(0.3)
                elif (recognizedHandGesture == 5 and full_screen!=True):
                    # entering full_screen
                    pyautogui.press('f')
                    full_screen = True
                    time.sleep(0.3)
                elif (recognizedHandGesture == 4 and full_screen!=False):
                    # exiting full_screen
                    pyautogui.press('esc')
                    full_screen = False
                    time.sleep(0.3)
                elif (recognizedHandGesture == 12):
